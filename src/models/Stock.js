...
const StockMovement = sequelize.define('StockMovement', {
  ...
  quantityChange: { type: DataTypes.DECIMAL(12, 4), allowNull: false, comment: 'Positive for IN, Negative for OUT. Always in BASE UNITS.', },
  previousQuantity: { type: DataTypes.DECIMAL(12, 4), allowNull: false, comment: 'Snapshot of stock before movement for audit', },
  newQuantity: { type: DataTypes.DECIMAL(12, 4), allowNull: false, comment: 'Snapshot of stock after movement for audit', },
